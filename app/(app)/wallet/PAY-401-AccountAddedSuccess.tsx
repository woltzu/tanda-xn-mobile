...
export default function AccountAddedSuccessScreen() {
  const [account] = useState({
    type: "bank" as "bank" | "card" | "mobilemoney",
    name: "Chase Bank",
    last4: "4532",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 style={{ margin: "0 0 8px 0", fontSize: "26px", fontWeight: "700" }}>{getTitle()} 🎉</h1>
        <p style={{ margin: 0, fontSize: "15px", opacity: 0.9 }}>You can now use this for deposits and withdrawals</p>
      </div>
      ...
      <div style={{ marginTop: "-60px", padding: "0 20px" }}>
        ...
        >
          ...
          <h2 style={{ margin: "0 0 4px 0", fontSize: "18px", fontWeight: "700", color: "#0A2342" }}>{account.name}</h2>
        ...
        >
          ...
          <div style={{ flex: 1, textAlign: "left" }}>
            <p style={{ margin: 0, fontSize: "15px", fontWeight: "600", color: "#0A2342" }}>Add Funds Now</p>
      ...
      >
        <button
          onClick={() => console.log("View All Methods")}
          style={{
            flex: 1,
            padding: "16px",
            borderRadius: "14px",
