...
export default function QuickActionsScreen() {
  ...
  const frequentActions = [
    { id: "f1", icon: "💰", label: "Add to Savings", action: "deposit" },
    { id: "f2", icon: "👀", label: "View Activity", action: "activity" },
    { id: "f3", icon: "📊", label: "Check XnScore", action: "xnscore" },
    { id: "f4", icon: "🎯", label: "Goals Progress", action: "goals" },
  ]
