-- Migration: 015_payout_execution_engine_v4.sql
-- Description: Payout Execution Engine - Credit Union Model
-- Fixed version: Removed non-immutable generated column
...
-- NOTE: is_locked is now a regular column, not generated
-- =====================================================
CREATE TABLE user_savings_goals (
    ...
    locked_until DATE,
    -- Removed: is_locked GENERATED column (not immutable)
...
-- Function to check if savings goal is locked
...
COMMENT ON FUNCTION is_savings_goal_locked(DATE) IS 'Check if a savings goal is currently locked based on locked_until date';
